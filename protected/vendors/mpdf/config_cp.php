...
function GetLangOpts($llcc, $adobeCJK) {
        ...
        //      else { $unifonts = ""; }
          ...
          // THAI
          CASE "th":  $unifonts = "garuda,garudaB,garudaI,garudaBI,norasi,norasiB,norasiI,norasiBI,THSaraban,THSarabanI,THSarabanB,THSarabanBI,CordiaNew,CordiaNewI,CordiaNewB,CordiaNewBI";  break;

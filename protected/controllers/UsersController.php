...
class UsersController extends Controller
{
	...
	public function actionProfile()
	{
		...
		$dataProvider=new CActiveDataProvider('Reservations', array(
			'pagination'=>array(
	...
	public function actionIndex()
	{
		...
		if(isset($_GET['search'])){
			...
			foreach ($keyword as $key => $value) {
				...
				$criteria->addSearchCondition('email', $value, true, 'OR' );
				$criteria->addSearchCondition('telephone', $value, true, 'OR' );
			}
		}
		
		$dataProvider=new CActiveDataProvider('EditUsers', array(
			'pagination'=>array(
				'pageSize'=>10,
			),
			'criteria'=>$criteria,
